...
.resource-detail-page__title { color: var(--u-sys-color-text); font-family: var(--bp-font-display, "HIA-uView BP Serif SC", "Source Han Serif SC", "Noto Serif SC", "Noto Serif CJK SC", serif); font-size: 25px; font-weight: 700; line-height: 1.25; }
