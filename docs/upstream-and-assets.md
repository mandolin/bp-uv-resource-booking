...
| --- | --- | --- | --- | --- |
| HIA-uView | `src/vendor/HIA-uView` | `246126457d7edf95bbc115304db1d891219b61c9` | MIT | 通过明确 Vite alias 使用 UI 源码、完整样式入口和主题 / UI source, complete style entry, and theme through explicit Vite aliases |
